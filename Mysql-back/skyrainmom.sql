...
--
-- Host: localhost    Database: skyrainmom
-- ------------------------------------------------------
...
CREATE TABLE `stus` (
  ...
  `stu_qq` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Dump completed on 2024-06-22 21:17:20
